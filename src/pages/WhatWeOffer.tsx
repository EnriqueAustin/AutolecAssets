    ...
    <>
      <section className="industrial-grid bg-field py-20">
        <div className="mx-auto max-w-7xl px-4 md:px-6">
          <p className="animate-fade-in-down mb-4 text-sm font-extrabold uppercase tracking-normal text-autolec-green">Nature of business</p>
                ...
                <Reveal key={service.title}>
                  <div className={`grid gap-8 rounded-md border border-ink/10 bg-field/40 p-6 md:p-8 lg:grid-cols-[1fr_1.2fr] lg:items-center ${index % 2 ? "lg:[direction:rtl] lg:[&>*]:[direction:ltr]" : ""}`}>
                    <div className="overflow-hidden rounded-md">
                      <img src={imageData.image} alt={service.title} className="h-72 w-full object-cover transition-transform duration-500 hover:scale-105 lg:h-80" />
                    </div>
                    <div>
